...
const Button = ({ Icon, text, type = "button", onClick, className = "" }) => {
  return (
    <button
      ...
      onClick={onClick}
      className={clsx(
        "group text-primary hover:border-primary flex cursor-pointer items-center justify-center rounded-md border border-transparent bg-[#E4F1FF] px-6 py-2.5 outline-none",
        className,
      )}
    >
